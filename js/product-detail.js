...
const products = [
  ...
  },
  {
    ...
    price: 370,
    images: [
      "images/pd921-cuero-1.jpg",
      "images/pd921-cuero-2.jpg",
      "images/pd921-cuero-3.jpg"
    ],
  ...
  },
  {
    ...
    price: 370,
    images: [
      "images/pd921-acero-1.jpg",
      "images/pd921-acero-2.jpg",
      "images/pd921-acero-3.jpg"
    ],
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Blanco con Bronce", hex: "#F5F5DC" }
    ],
    badge: "ELEGANTE"
  },
  {
        ...
        ${currentProduct.colors.map(color => `
          <div class="color-option" 
               ...
               style="
                 ...
                 transition: 0.3s;
                 ${color.hex === '#ffffff' || color.hex === '#FFFFFF' ? 'box-shadow: inset 0 0 0 1px #ccc;' : ''}
               "
